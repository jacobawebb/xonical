...
import { Globe, MapPin, Shield, X } from "lucide-react";
            ...
            <nav className={`w-full max-w-full flex ${gapLayout} justify-center xl:justify-between items-center flex-wrap xl:flex-nowrap`}>
                ...
                <div className={`w-max items-center justify-end flex gap-6 h-full flex-wrap xl:flex-nowrap`}>
                    <Box className="flex flex-col gap-3 justify-center items-center p-3" special>
                        <Link href={'/security'}>
                            <Title type="h2" removeTag className="transition ease-in-out hover:opacity-75">Security <Shield className="text-primary" /></Title>
                        </Link>
                ...
                <div className="flex flex-col justify-between gap-3">
                    <div className={`w-full h-full flex justify-between items-center gap-6`}>
                        <span className="text-xl">Making tech, <strong className="text-primary">work</strong>.</span>
