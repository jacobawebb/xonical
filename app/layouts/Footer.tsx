...
import { Eye, FileCheck, Fingerprint, Globe, Layout, Server, Shield, Siren, Terminal, Wrench, Zap } from "lucide-react";
					...
					<Row type="layout" className="w-max">
						<Col type="content">
							...
							<Link href={"/security/alarms"} className="relative w-max group">
								...
								<Row type="content" className="items-center" reduceGap>
									Alarm Systems
									<Siren size={iconSize} className="text-primary" />
								</Row>
							</Link>
							<Link href={"/security/access-control"} className="relative w-max group">
								...
								<Row type="content" className="items-center" reduceGap>
									...
									<Fingerprint size={iconSize} className="text-primary" />
								</Row>
							</Link>
						</Col>
						<Col type="content">
							...
							<Link href={"/electrical/installations"} className="relative w-max group">
								<div className="absolute left-0 -bottom-1 w-1/3 h-[2px] bg-primary group-hover:w-full transition-all ease-in-out"></div>
								<Row type="content" className="items-center" reduceGap>
									Electrical Installations
									<Wrench size={iconSize} className="text-primary" />
								</Row>
							</Link>
							<Link href={"/electrical/inspections"} className="relative w-max group">
								<div className="absolute left-0 -bottom-1 w-1/3 h-[2px] bg-primary group-hover:w-full transition-all ease-in-out"></div>
								<Row type="content" className="items-center" reduceGap>
									Electrical Inspections
									<FileCheck size={iconSize} className="text-primary" />
								</Row>
							</Link>
							<Link href={"/electrical/maintenance"} className="relative w-max group">
								<div className="absolute left-0 -bottom-1 w-1/3 h-[2px] bg-primary group-hover:w-full transition-all ease-in-out"></div>
								<Row type="content" className="items-center" reduceGap>
						...
						<Col type="content">
							...
							<Link href={"/digital/websites"} className="relative w-max group">
								...
								<Row type="content" className="items-center" reduceGap>
									Website Design
									<Layout size={iconSize} className="text-primary" />
								</Row>
							</Link>
							<Link href={"/digital/hosting"} className="relative w-max group">
								...
								<Row type="content" className="items-center" reduceGap>
									Web Hosting
									<Server size={iconSize} className="text-primary" />
								</Row>
							</Link>
							<Link href={"/digital/software"} className="relative w-max group">
								...
								<Row type="content" className="items-center" reduceGap>
									...
									<Terminal size={iconSize} className="text-primary" />
								</Row>
							</Link>
						</Col>
					</Row>
					<Col type="content" className="items-end">
						<Title type="h2" removeTag>
							{`Open 24/7`}
						</Title>
						<Paragraph className="text-sm text-primary w-72 text-right">{`We're always ready for new and existing clients. Reach out to a member of the team anytime to discuss your needs.`}</Paragraph>
						<Button className="self-end" href="/contact">
							Contact
						</Button>
					</Col>
				</Row>
